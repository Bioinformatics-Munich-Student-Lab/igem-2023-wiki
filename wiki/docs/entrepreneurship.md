...
In order to remedy these shortcomings, we scheduled a meeting with Silicon Valley-based venture capitalist Mani Honigstein of [HoneystoneVC](https://www.honeystonevc.com/). He provided us with valuable lessons and expressed interest in joining the project in an advisory role. [HoneystoneVC](https://www.honeystonevc.com/) have a proven trackrecord of supporting startups in their journeys and are a crucial partner to any startup in their portfolio. Our meeting paves the way for us to enter their ecosystem, allowing us to rely on their intricate knowledge on operating a startup. 
